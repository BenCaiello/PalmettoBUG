...
def do_K_L_g(pointpattern: pd.DataFrame, 
    ...
    ##>>## much of the code until the next ##>>## marked comment was generated by AI, then edited
    try:
        import .._central as rk
        rk = rk._rust_k
        from rk import k_cross_homogeneous_py as _rust_k_cross, has_rust as _rust_available
    except Exception:
